...
  // 1. Make sure to add this import line at the very top of your App.jsx file:
// import autoTable from "jspdf-autotable";
...
                <input type="text" name="name" required value={formData.name} onChange={handleInputChange} className="w-full bg-[#111827] border border-slate-700 rounded-lg p-2.5 text-white focus:outline-none focus:border-blue-500" placeholder="Neev Rathod" />
              </div>
            )}
            <div>
              <label className="text-xs font-bold text-slate-400 tracking-wider uppercase block mb-1">Email Address</label>
              <input type="email" name="email" required value={formData.email} onChange={handleInputChange} className="w-full bg-[#111827] border border-slate-700 rounded-lg p-2.5 text-white focus:outline-none focus:border-blue-500" placeholder="you@health.com" />
            </div>
            <div>
